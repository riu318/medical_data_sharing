...
public class EncryptDecrypt {
    ...
    public static void main(String arg[]) {
        ...
        String str1 = "163169169163154157163154166219207223219207223219227231";
        String str = "abcdefghijklmnopqrstuvwwwwxyyzzzz";
        String enCryptStr = edObj.Encrypt(str);
        String enCryptStr1 = edObj.Encrypt(str1);
        System.out.println(" Encrypted string : " + enCryptStr);
        System.out.println(" Decrypted string : " + edObj.Decrypt(enCryptStr));
        System.out.println(" Encrypted string : " + enCryptStr1);
        System.out.println(" Decrypted string : " + edObj.Decrypt(enCryptStr1));
    }
