...
String c = request.getParameter("doa");
...
<div id="innerpageContent" style="background-color: honeydew;"> 
      ...
      <div class="contentshedow">
		...
		<div class="columnMaster">
              <div class="columnLeft"> 
               <form name="patientregistrationform" method="post" id="patientregistrationform" action="AppRe.jsp">
                ...
                <div class="apply_online">
               	 <div class="apply_online">
                  <h1>Date Of Appoinment</h1>
                  <input id="patient_name" title="Patient's Name" name="doa" value="<%=c %>"  type="text" class="textinput" readonly>
                </div>
                 
                  
              <div class="apply_online">
                  <h1>Hospital </h1>
                  <input id="patient_name" title="Patient's Name" name="hospital" value="<%=d %>"  type="text" class="textinput" readonly>
                </div>
               <div class="apply_online">
                  <h1>Specialist</h1>
                  <input id="patient_name" title="Patient's Name" name="special" value="<%=e %>"  type="text" class="textinput" readonly>
                </div>
               </div>
 ...
 ResultSet rs2 = stmt.executeQuery("Select * from dreg where special='"+e+"'");
 while(rs2.next()){
     %>
