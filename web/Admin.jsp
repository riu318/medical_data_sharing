...
<div id="innerpageContent" style="background-color: honeydew;"> 
	<div class="wrapper"> 
        ...
        <div class="pagepath">
        	<ul>
            	<li><a href="index.php" title="Home"><img src="images/homeico.png" width="13" height="13" alt="Patient Registration Form" title="Patient Registration Form"/></a></li>
            	<li><a href="index.php" title="Home">Home</a></li>
                <li><span> > </span></li>
                <li title="Patient Registration Form"> Login Form</li>
            </ul>
        </div>
      ...
      <div class="contentshedow">
		...
		<div class="columnMaster">
              ...
              <form name="patientregistrationform" method="post" id="patientregistrationform" action="Admin">
