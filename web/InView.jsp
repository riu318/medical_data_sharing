...
<table class="responstable">
  ...
  <tr>
          ...
          <td><%=k %></td>
          <td><%=l %></td>
         <td><a href="InView1.jsp?id=<%=a%>&&name=<%=b %>&&email=<%=c%>&&dob=<%=d%>&&age=<%=e%>&&sex=<%=g%>&&mobile=<%=h%>&&address=<%=i%>">Try To Modify</a></td>
...
<br><br>
<center><a href="IHome.jsp">CLick here to move back</a></center>
